      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          {['name','designation','experience','email','mobile','facebook','instagram','linkedin'].map(field => (
            <div key={field}>
              <label className="block text-xs text-black font-semibold capitalize mb-1">{field}</label>
          ...
          <div>
            <label className="block text-xs text-black font-semibold mb-1">Description</label>
          ...
          <div>
            <label className="block text-xs text-black font-semibold mb-1">Profile Photo</label>
          ...
          <tbody>
            {members.map(m => (
              <tr key={m._id} className="border-b hover:bg-gray-50">
                ...
                <td className="p-3 text-black">{m.designation || m.role}</td>
